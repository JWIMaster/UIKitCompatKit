...
//  LFGlassView.m
//
//  Updated to correctly handle nested container views for snapshotting
//
...
- (void)recreateImageBuffersForVisibleRect:(CGRect)visibleRect {
    ...
    // transform to match snapshot target view
    CGContextConcatCTM(effectInContext, (CGAffineTransform){1.0, 0, 0, -1.0, 0, bufferSize.height});
